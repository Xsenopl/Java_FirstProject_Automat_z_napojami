public class cNapoj {
    ...
    private int ilosc, nr_na_liscie;
    private double cena;
    ...
    public int getNr_na_liscie() { return nr_na_liscie; }

    public void setNazwa(String nazwa) {  this.nazwa = nazwa; }
    public void setIlosc(int ilosc) { this.ilosc = ilosc; }
    public void setNr_na_liscie(int nr_na_liscie) { this.nr_na_liscie = nr_na_liscie; }
